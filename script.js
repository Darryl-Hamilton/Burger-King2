document.addEventListener("DOMContentLoaded", function(){
  ...
  img1.setAttribute("src", "https://cdn.sanity.io/images/czqk28jt/prod_bk_gb/01676f8fbe53e18504a3dc633b777ffe54080bb9-1000x500.png?w=750&q=40&fit=max&auto=format");
  ...
  title1.innerHTML = "OFFER: 2 for 1 Spicy Mayo"; // Add title text
  ...
  description1.innerHTML = "<b> Free Spicy Mayo Double when you buy one. Only on the App 7-10 May."; // Add description text
  ...
  button1.innerHTML = "Redeem offer"; // Add button text
...
/*****************************BOX 2**************************************/
  ...
  img2.setAttribute("src", "https://cdn.sanity.io/images/czqk28jt/prod_bk_gb/8a25cc8ee1532281a9fb7de4c36e25408a7c6294-1000x500.jpg?w=750&q=40&fit=max&auto=format");
  ...
  title2.innerHTML = "£1 Royale for you and a loyal mate!"; // Add title text
  ...
  description2.innerHTML = "Invite your bestie to join YourBurgerKing and get rewarded this May.<b>"; // Add description text
  ...
  button2.innerHTML = "Sign up to get referral code"; // Add button text
 ...
 /***************************BOX 3****************************************/
  ...
  img4.setAttribute("src", "https://cdn.sanity.io/images/czqk28jt/prod_bk_gb/6eaa0164bc3d7dcdb408764aa630088803e2b83a-1000x500.png?w=750&q=40&fit=max&auto=format");
  ...
  title4.innerHTML = "NEW Halloumi Fries"; // Add title text
  ...
  description4.innerHTML = "<b>100% authenic Cypriot Halloumi, golden and cheesy fries."; // Add description text
  ...
  textElement.textContent = "TM & Copyright 2021 Burger King Corporation. All Rights Reserved. ";
